...
//allowed types of grasps:
#define ALLOW_P1_GRASPS		1
#define ALLOW_P2_GRASPS		1
...
#define TARGET_Z 50.0 //mm Defines at which height the target object should be grasped
